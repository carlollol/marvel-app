...
// function initialize(){
  ...
  firebase.initializeApp(config);
    ...
    database.ref().on("child_added", function(childSnapshot, prevChildKey) {
        ...
        heroes.push(heroNew);
        console.log(heroes)
        var start = $("<div class='panel panel-default'><div class='panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordion' href='#collapse" +heroes.length+"'>"+heroId+"</a></h4></div><div id='collapse"+heroes.length+"' class='panel-collapse collapse'><div class='panel-body'><section><strong><h5>Name:</strong> "+heroName+"</h5><strong><h5>Powers: </strong>"+heroPowers+"</h5><video height='300px' autoplay muted loop class='bgvid'><source src='"+heroFootage+"' type='video/mp4'></video></section></div></div></div>");
         $("#accordion").append(start);
    });


        // getCoordinates(i);
        // console.log('turn ' + i + ' done');
// }

// function getCoordinates(i){
//     // console.log(document.querySelector('#map0'));
//     // console.log(document.getElementById('map0'));
//     map = new google.maps.Map(document.getElementById('map' + i), heroes[i].options);
...
// }
       ...
       // var temp1 = "mapOption" + [i];
        ...
        // temp1 = {
        //  zoom: 15,
        //  center: new google.maps.LatLng(18.520266,73.856406),
